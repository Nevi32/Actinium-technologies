...
<body>
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <button onclick="downloadDetailedInfo()" class="download-button">Download</button>
        </div>
    </div>
</div>
    ...
    function downloadSalesData() {
        const salesDataText = JSON.stringify(salesData, null, 2);
        const blob = new Blob([salesDataText], { type: 'text/plain' });
